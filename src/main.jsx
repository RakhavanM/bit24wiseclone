...
function Converter() {
  ...
  return (
    <div className="converter-card" id="convert">
      ...
      <a className="primary-button large" href="#/trade/spot-terminal">ورود به بازار <ArrowLeft size={20} /></a>
